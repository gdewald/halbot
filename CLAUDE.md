...
- No ORM, no frameworks beyond discord.py — keep it simple and single-file
...
- **max_tokens**: Currently 512. If the LLM's response gets truncated (`finish_reason=length`), the JSON will be incomplete and parsing fails. Increase if adding verbose actions.
